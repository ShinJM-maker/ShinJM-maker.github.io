window.PUBLICATIONS = [
  ...
  },
  {
    ...
    date: "2026",
    authorsHtml: "Anonymous (Under review)",
    abstract: "Anonymous manuscript on compiling natural-language instructions into executable structures for reliable agent planning.",
    contribution: "A validated intermediate representation maps instructions into executable operations, task-critical arguments, and prerequisite/dataflow structure.",
    role: "First Author",
    status: "Under Review",
  ...
  },
  {
    ...
    contribution: "A matched-intervention diagnostic framework analyzes how upstream parsing uncertainty propagates across representation families.",
    role: "First Author",
    status: "Under Review",
