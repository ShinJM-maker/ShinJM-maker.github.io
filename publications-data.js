window.PUBLICATIONS = [
  {
    ...
    contribution: "Details withheld during embargo period.",
    role: "First Author",
    status: "Accepted",
  ...
  {
    slug: "under-review-hierarchical-retrieval",
    category: "Under Review",
    title: "Anonymous manuscript on hierarchical multimodal retrieval (details withheld during review)",
    venue: "Under Review",
    date: "2026",
    authorsHtml: "Anonymous (Under review)",
    abstract: "This work addresses hierarchical multimodal retrieval for open-domain document question answering. Details are withheld during the review period.",
    contribution: "Hierarchical retrieval framework combining global routing, local ranking, and ancestry-aware evidence assembly.",
    role: "First Author",
    status: "Under Review",
    keywords: ["hierarchical retrieval", "multimodal", "evidence assembly"],
    doi: "",
    arxiv: ""
  },
  {
