window.PUBLICATIONS = [
  ...
  },
  {
    ...
    date: "",
    authorsHtml: "Anonymous (Under review)",
    contribution: "Joint measurement of retrieval relevance, evidence breadth, faithfulness, latency, memory, and cost for fair chunker comparison.",
    role: "First Author",
    status: "Under Review",
  ...
  },
  {
    ...
    category: "Under Review",
    title: "Delivered-Pack Sensitivity Diagnostics for Document-Agent Memory Commits",
    venue: "EMNLP 2026",
    date: "",
    authorsHtml: "Anonymous (Under review)",
    contribution: "Demonstrates that final-answer correctness alone is not evidence of grounding; proposes diagnostics on what an agent commits to memory.",
    role: "First Author",
    status: "Under Review",
  ...
  },
  {
    ...
    category: "Under Review",
    title: "Timestamp-Grounded Evidence Consumption Auditing for Long-Video QA/RAG",
    venue: "EMNLP 2026",
    date: "",
    authorsHtml: "Anonymous (Under review)",
    contribution: "Shifts video QA/RAG evaluation beyond final-answer accuracy by auditing which timestamped segments were actually consumed.",
    role: "First Author",
    status: "Under Review",
  ...
  },
  {
    ...
    category: "Under Review",
    title: "Evidence-State Control for Repairing, Recalibrating, and Materializing Retrieved Candidates",
    venue: "ML Conference",
    date: "",
    authorsHtml: "Anonymous (Under review)",
    contribution: "Controllable repair, recalibration, and materialization of retrieved candidates before reader-context packing.",
    role: "First Author",
    status: "Under Review",
  ...
  },
  {
    ...
    category: "Under Review",
    title: "Answer-Side Attribution Analysis of OCR, Evidence Placement, Answer Policy, and Reader Family",
    venue: "ML Conference",
    date: "",
    authorsHtml: "Anonymous (Under review)",
    contribution: "Attribution analysis of how OCR quality, evidence placement, answer policy, and reader family interact to affect answer-quality gains.",
    role: "First Author",
    status: "Under Review",
  ...
  },
  {
    ...
    category: "Under Review",
    title: "Multimodal, Multi-Document, Page-Annotated Benchmark Dataset for Open-Domain Document QA",
    venue: "EMNLP 2026",
    date: "",
    authorsHtml: "Anonymous (Under review)",
    contribution: "A multimodal multi-document benchmark with page-level annotations for open-domain document QA.",
    role: "Co-Author",
    status: "Under Review",
  ...
  },
  {
    slug: "ur-vqa-survey",
    category: "Under Review",
    title: "Comprehensive Survey of Visual Question Answering: Methods, Benchmarks, and Evaluation Paradigms",
    venue: "EMNLP 2026",
    date: "",
    authorsHtml: "Anonymous (Under review)",
    contribution: "Comprehensive survey of VQA methods, benchmarks, and evaluation paradigms.",
    role: "Co-Author",
    status: "Under Review",
  ...
  },
  {
    ...
    category: "Under Review",
    title: "Survey and Audit Framework for Reliability and Safety of Multimodal Agent Systems",
    venue: "EMNLP 2026",
    date: "",
    authorsHtml: "Anonymous (Under review)",
    contribution: "Survey and unified audit framework for the reliability and safety of multimodal agent systems.",
    role: "Co-Author",
    status: "Under Review",
  ...
  },
  {
    ...
    category: "Under Review",
    title: "Guiding Retrieval and Reasoning for Reasoning-Efficient Agentic RAG Systems",
    venue: "EMNLP 2026",
    date: "",
    authorsHtml: "Anonymous (Under review)",
    contribution: "Retrieval- and reasoning-guidance methods for reasoning-efficient agentic RAG systems.",
    role: "Co-Author",
    status: "Under Review",
